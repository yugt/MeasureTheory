...
\centerline{\fourteenbf Volume 2}
...
\Centerline{\it First edition May 2001}
     
\Centerline{\it Hardback edition January 2010}
     
\Centerline{\it Second printing April 2016}
...
\centerline{\twentybf Volume 2}
     
\bigskip\bigskip
     
\centerline{\twentyrm Broad Foundations}
...
\noindent First published in 2001
...
published in {\tt http://www.gnu.org/licenses/dsl.html}.   For the source
files see {\tt http://www.essex.\discretionary{}
...
General Introduction \pagereference{9}{}
...
\def\volumename{Broad foundations}
...
\wheader{{\it Introduction to Volume 2}}{18}{6}{6}{48pt}
