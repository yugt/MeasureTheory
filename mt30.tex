...
\Centerline{\it First printing May 2002}

\Centerline{\it Second printing corrected April 2002}
...
author's Web page {\tt
http://www.essex.ac.uk/maths/staff/fremlin{\penalty-50}/mtsales.htm}, or enquire from {\tt fremdh\@essex.ac.uk}.
}%end of vbox
...
Patents Act 1988.
This work is issued under the terms of the Design Science License as published in {\tt http://dsl.org/copyleft/dsl.txt}.   For the source files see {\tt http://www.essex.\discretionary{}
...
\quad General Introduction \pagereference{10}{}

\input mt03

\medskip

\quad Index to Volumes 1-3

\qquad Principal topics and results \pagereference{633}{}

\qquad General index \pagereference{641}{}
...
As I write this Introduction (February 2004), the plan of the work is
as follows:
...
\wheader{{\it Introduction to Volume 3}}{18}{6}{6}{48pt}

\noindent{\bf Introduction to Volume 3}
...
{\tt http://www.essex.ac.uk/maths/staff/fremlin\penalty-100/mterr3.02.ps}.
