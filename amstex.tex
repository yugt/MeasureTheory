% Version of amstex.tex downloaded on 15.6.05 
% For my own changes look for the string DHF

\DHFamstexloadedtrue   %DHF 15.6.05
...
%DHF In order to get eight-point \Bbb and \frak fonts, 
%I found no alternative to the following interpolation.
\def\loadmsBm{                            %DHF 15.6.05
 \font@\eightmsb=msbm8                    %DHF 15.6.05
 \alloc@@8\fam\chardef\sixt@@n\msBfam     %DHF 15.6.05
 \textfont\msBfam=\eightmsb               %DHF 15.6.05
 \global\let\loadmsBm\empty               %DHF 15.6.05
 }                                        %DHF 15.6.05
\def\loadmsFm{                            %DHF 18.6.05
 \font@\eighteufm=eufm8                   %DHF 18.6.05
 \alloc@@8\fam\chardef\sixt@@n\msFfam     %DHF 18.6.05
 \textfont\msFfam=\eighteufm              %DHF 18.6.05
 \global\let\loadmsFm\empty               %DHF 18.6.05
 }                                        %DHF 18.6.05
...
%DHF I apologize to the TeX community for breaking the
%no-changes-without-changing-filename rule.   The reason is that I want my
%own TeXfiles to run on other people's systems with minimal chance of
%disruption.   They therefore use  \input amstex  like everyone else.
%If you run my files on a standard version of  amstex.tex  they should
%still compile with minimal deterioration.
